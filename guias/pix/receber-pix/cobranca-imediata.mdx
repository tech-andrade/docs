...
Se você precisa de um código **reutilizável**, sem expiração, capaz de receber múltiplos pagamentos, use a [Cobrança Reutilizável (QR Estático)](/guides/pix/cobranca-reutilizavel) em vez desta.

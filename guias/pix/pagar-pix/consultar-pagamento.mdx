...
<Note>
  Esta página trata do **status** da transação, em JSON. Para o comprovante oficial em PDF de uma transação já liquidada, veja [Comprovante de Transação](/guias/pix/comprovante).
</Note>

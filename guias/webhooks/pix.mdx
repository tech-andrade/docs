...
<Note>
  O objeto `proof` nos payloads abaixo traz os **dados** da transação em JSON, para o seu sistema processar. Se o que você precisa é o **comprovante oficial em PDF** para entregar ao usuário final, veja [Comprovante de Transação](/guias/pix/comprovante).
</Note>

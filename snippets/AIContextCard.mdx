<div className="relative">
  ...
  <label
    ...
    className="group block cursor-pointer rounded-2xl border border-gray-200 bg-white p-6 md:p-7 no-underline hover:border-gray-300 hover:shadow-lg transition-all overflow-hidden relative"
  >
    ...
    <div className="relative flex min-h-[220px] flex-col justify-between">
      <div>
        <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-xl border border-[#1A941A]/20 bg-[#1A941A]/10 text-xl">
          ⬇️
        </div>

        <h2 className="mb-3 text-xl font-bold tracking-tight text-gray-950">

...
<Note>
  Para entender quando usar este endpoint e ver o passo a passo completo, veja o guia [Cobrança Reutilizável (QR Code
  Estático)](/guias/pix/receber-pix/cobranca-reutilizavel).
</Note>
